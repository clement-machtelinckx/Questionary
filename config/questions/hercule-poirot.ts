...
export const herculePoirotCategory: QuestionCategory = {
    ...
    questions: [
        createPoirotQuestion(
            "hercule-poirot-001",
            "Dans quel roman Hercule Poirot apparaît-il pour la première fois ?",
            [
        ...
        createPoirotQuestion(
            ...
            ["En France", "En Belgique", "En Suisse", "En Égypte"],
            "a",
        ...
        createPoirotQuestion(
            "hercule-poirot-004",
            "Dans Les Quatre, à quel type d’adversaire Poirot est-il confronté ?",
            [
                "Une société d’archéologues rivaux",
                "Une famille de faussaires provinciaux",
                "Un réseau de contrebandiers maritimes uniquement",
        ...
        createPoirotQuestion(
            "hercule-poirot-005",
            "Quelle destination est au cœur du voyage dans Le Train bleu ?",
            ["Les Highlands écossais", "La côte dalmate", "La Côte d’Azur", "Les Alpes autrichiennes"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Nick Buckley", "Norma Restarick", "Linnet Ridgeway", "Elinor Carlisle"],
            "a",
        ...
        createPoirotQuestion(
            ...
            [
                "Une congère bloque la voie",
                "Une grève ferme la frontière",
                "Un pont s’effondre devant le train",
                "Une panne de charbon arrête la locomotive",
            ],
            "a",
        ...
        createPoirotQuestion(
            "hercule-poirot-008",
            "Dans La Mort dans les nuages, où la victime est-elle découverte ?",
            ["À bord d’un avion", "Dans une cabine de paquebot", "Dans un compartiment de train", "Dans une montgolfière"],
            "a",
        ...
        createPoirotQuestion(
            ...
            ["Les phases de la Lune", "Les signes du zodiaque", "Un ordre alphabétique", "Les numéros d’un jeu de cartes"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Une compagnie de théâtre", "Un laboratoire pharmaceutique", "Une mission archéologique", "Une école militaire"],
            "c",
            "L’intrigue se déroule sur un chantier de fouilles au Moyen-Orient, au sein d’une équipe d’archéologues.",
        ),
        createPoirotQuestion(
            "hercule-poirot-011",
            "Quel jeu structure la soirée décisive de Cartes sur table ?",
            ["Le poker", "Le bridge", "Le mah-jong", "Le backgammon"],
            "b",
        ...
        createPoirotQuestion(
            "hercule-poirot-012",
            "Quel voyage forme le cadre principal de Mort sur le Nil ?",
            ["Une traversée de la Manche", "Une croisière sur le Nil", "Une expédition dans l’Atlas", "Un trajet sur le Danube"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["Simeon Lee", "Roger Ackroyd", "Gordon Cloade", "Richard Abernethie"],
            "a",
            "Le riche patriarche Simeon Lee convoque ses proches à Gorston Hall, où les tensions familiales éclatent avant sa mort.",
        ),
        createPoirotQuestion(
            "hercule-poirot-014",
            "Quel décor accueille Poirot dans Les Vacances d’Hercule Poirot ?",
            ["Un sanatorium dans les Alpes", "Un palais vénitien", "Un hôtel sur une île au large du Devon", "Un ranch en Argentine"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Trois ans", "Huit ans", "Seize ans", "Trente ans"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["La serre", "Le court de tennis", "La piscine", "La bibliothèque"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Le capitaine Hastings", "Miss Lemon", "Le superintendant Spence", "L’inspecteur Battle"],
            "c",
        ...
        createPoirotQuestion(
            ...
            [
                "L’avocat annonce la disparition du testament",
                "Le médecin reconnaît avoir falsifié l’heure du décès",
                "Le majordome révèle un cambriolage nocturne",
                "Cora affirme que le défunt a été assassiné",
            ],
            "d",
        ...
        createPoirotQuestion(
            "hercule-poirot-019",
            "Quel divertissement Ariadne Oliver organise-t-elle dans Poirot joue le jeu ?",
            ["Une chasse au meurtrier fictive", "Un concours de romans policiers", "Une vente aux enchères costumée", "Une séance publique d’hypnose"],
            "a",
            "Pour une fête de village, Ariadne Oliver imagine un jeu de meurtre ; l’exercice prend une tournure réelle et dangereuse.",
        ),
        createPoirotQuestion(
            "hercule-poirot-020",
            "Quel établissement sert de cadre principal à Un chat dans les pigeons ?",
            ["Un pensionnat naval", "Une école de jeunes filles", "Une université de médecine", "Un conservatoire de musique"],
            "b",
            "L’intrigue se concentre sur Meadowbank, une prestigieuse école anglaise pour jeunes filles.",
        ),
        createPoirotQuestion(
            "hercule-poirot-021",
            "Quels objets insolites entourent la scène du crime dans Les Pendules ?",
            ["Des masques de théâtre", "Des bouteilles miniatures", "Des cartes postales déchirées", "Plusieurs horloges"],
            "d",
        ...
        createPoirotQuestion(
            ...
            [
                "À la troisième fille d’un aristocrate",
                "À la troisième élève disparue d’un collège",
                "À la troisième actrice d’une troupe",
                "À la troisième occupante d’un appartement partagé",
            ],
            "d",
        ...
        createPoirotQuestion(
            ...
            ["Une fête de Noël", "Une fête d’Halloween", "Une garden-party estivale", "Un bal du Nouvel An"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["End House", "Meadowbank", "Styles Court", "Le Jolly Roger Hotel"],
            "c",
        ...
        createPoirotQuestion(
            "hercule-poirot-026",
            "Combien de récits composent le recueil britannique Murder in the Mews ?",
        ...
        createPoirotQuestion(
            "hercule-poirot-027",
            "Combien d’enquêtes composent le cycle des Travaux d’Hercule ?",
            ["Sept", "Douze", "Dix", "Treize"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["Une épidémie inconnue", "Un sabotage ferroviaire", "Une société secrète italienne", "La malédiction d’un tombeau"],
            "d",
        ...
        createPoirotQuestion(
            ...
            ["Le Double Indice", "Le Bal de la Victoire", "Le Mystère de Hunter’s Lodge", "La Boîte de chocolats"],
            "d",
        ...
        createPoirotQuestion(
            ...
            ["Celle d’un joaillier", "Celle d’une cuisinière", "Celle d’un diplomate", "Celle d’un jockey"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["Le Premier ministre britannique", "Le président français", "Le roi des Belges", "L’ambassadeur des États-Unis"],
            "a",
            "Poirot doit retrouver le chef du gouvernement britannique à temps pour une conférence internationale majeure.",
        ),
        createPoirotQuestion(
            "hercule-poirot-032",
            "Quel récit ouvre le cycle des Travaux d’Hercule ?",
            ["Les Oiseaux du lac Stymphale", "Le Lion de Némée", "La Ceinture d’Hippolyte", "Les Écuries d’Augias"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["Française", "Belge", "Suisse", "Néerlandaise"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["Avocat", "Médecin légiste", "Policier", "Journaliste"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Ses facultés de raisonnement", "Une brigade secrète de la police", "Des dossiers classés par couleur", "Une méthode d’analyse chimique"],
            "a",
        ...
        createPoirotQuestion(
            ...
            ["Le désordre créatif", "Les sports à risque", "L’ordre et la symétrie", "Les voyages improvisés"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Baker Street Chambers", "Bertram’s Court", "Styles Apartments", "Whitehaven Mansions"],
            "d",
        ...
        createPoirotQuestion(
            ...
            ["Sa barbe carrée", "Sa moustache", "Ses favoris", "Son monocle"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["Ami, compagnon et parfois narrateur", "Médecin légiste officiel", "Procureur chargé des poursuites", "Rival à la tête d’une agence concurrente"],
            "a",
            "Hastings accompagne Poirot dans de nombreuses premières enquêtes et raconte plusieurs aventures à la première personne.",
        ),
        createPoirotQuestion(
            "hercule-poirot-040",
            "À quelle institution l’inspecteur-chef Japp est-il associé ?",
            ["La Sûreté belge", "Interpol", "Le MI6", "Scotland Yard"],
            "d",
            "Japp est un policier de Scotland Yard qui collabore régulièrement avec Poirot, malgré leurs méthodes différentes.",
        ),
        createPoirotQuestion(
            "hercule-poirot-041",
            "Quelle fonction Miss Felicity Lemon exerce-t-elle auprès de Poirot ?",
            ["Secrétaire", "Gouvernante", "Avocate", "Photographe judiciaire"],
            "a",
            "Miss Lemon est une secrétaire remarquablement efficace, connue pour son organisation et sa précision.",
        ),
        createPoirotQuestion(
            "hercule-poirot-042",
            "Quelle profession exerce Ariadne Oliver ?",
            ["Archéologue", "Directrice d’école", "Cantatrice", "Autrice de romans policiers"],
            "d",
        ...
        createPoirotQuestion(
            ...
            ["Comme sa sœur installée à Londres", "Comme une inspectrice de Scotland Yard", "Comme une aristocrate russe fascinante et récurrente", "Comme la secrétaire d’Ariadne Oliver"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Vingt-quatre", "Trente", "Trente-trois", "Quarante-deux"],
            "c",
        ...
        createPoirotQuestion(
            ...
            ["Poirot quitte la scène", "Les Pendules", "Une mémoire d’éléphant", "La Troisième Fille"],
            "a",
        ...
        createPoirotQuestion(
            ...
            ["Des réfugiés belges", "Des diplomates suisses", "Des marins norvégiens", "Des étudiants canadiens"],
            "a",
        ...
        createPoirotQuestion(
            ...
            ["Peter Ustinov", "John Malkovich", "Alfred Molina", "David Suchet"],
            "d",
        ...
        createPoirotQuestion(
            ...
            ["Peter Sellers", "Albert Finney", "Alec Guinness", "Laurence Olivier"],
            "b",
        ...
        createPoirotQuestion(
            ...
            ["Ridley Scott", "Tom Hooper", "Sam Mendes", "Kenneth Branagh"],
            "d",
